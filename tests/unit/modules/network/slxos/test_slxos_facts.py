...
from ansible_collections.extreme.slxos.plugins.modules import slxos_facts
...
class TestSlxosFactsModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.extreme.slxos.plugins.modules.slxos_facts.run_commands')
