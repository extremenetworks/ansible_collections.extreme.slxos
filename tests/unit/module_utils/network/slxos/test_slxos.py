...
from ansible_collections.extreme.slxos.tests.unit.compat import unittest
from ansible_collections.extreme.slxos.plugins.module_utils.network.slxos import slxos
...
class TestPluginCLIConfSLXOS(unittest.TestCase):
    ...
    @patch('ansible_collections.extreme.slxos.plugins.module_utils.network.slxos.slxos.Connection')
